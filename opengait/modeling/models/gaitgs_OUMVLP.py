...
class MGFE(nn.Module):
    def __init__(self, in_c):
        ...
        self.STEM_S0 = STEM(in_c[0], in_c[1], halving=1)
        self.STEM_S1 = nn.Sequential(
            STEM(in_c[1], in_c[2], halving=1),
            STEM(in_c[2], in_c[2], halving=1),
            STEM(in_c[2], in_c[3], halving=1)
        )

        self.STEM_C0 = STEM(in_c[0], in_c[1], halving=1)
        ...
        self.UTA2 = BasicConv3d(in_c[-1], in_c[-1], kernel_size=(3, 1, 1), stride=(3, 1, 1), padding=(0, 0, 0))
...
class GaitGS_OUMVLP(BaseModel):
    def __init__(self, *args, **kargs):
        super(GaitGS_OUMVLP, self).__init__(*args, **kargs)
    ...
    def build_network(self, model_cfg):
        ...
        self.Head1 = SeparateFCs(parts_num * 2, in_c[-1], class_num)
